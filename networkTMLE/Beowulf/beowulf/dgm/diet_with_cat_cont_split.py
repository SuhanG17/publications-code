...
def diet_dgm(network, restricted=False,
    ...
    if update_split:
        cat_vars.append('diet')
        cont_vars.append('bmi')
        cat_unique_levels['diet'] = pd.unique(data['diet'].astype('int')).max() + 1
...
if __name__ == '__main__':
    ...
    H, cat_vars, cont_vars, cat_unique_levels = diet_dgm(G, restricted=False, 
