...
for i in range(n_mc):
    ...
    ntmle = NetworkTMLETimeSeries(network_list, exposure='vaccine', outcome='D', verbose=False, degree_restrict=(0, 18),
    ...
    if use_deep_learner_outcome:
        ...
        if deep_learner_outcome is None:
    ...
    ntmle.outcome_model(qn_model, custom_model=q_estimator, custom_model=deep_learner_outcome) 
