...
if network == "uniform":
    ...
    G, cat_vars, cont_vars, cat_unique_levels = load_uniform_naloxone(n=n_nodes, return_cat_cont_split=True)
if network == "random":
    # G = load_random_naloxone(n=n_nodes)
    G, cat_vars, cont_vars, cat_unique_levels = load_random_naloxone(n=n_nodes, return_cat_cont_split=True)
...
for i in range(n_mc):
    ...
    H, cat_vars, cont_vars, cat_unique_levels = naloxone_dgm(network=G, restricted=restrict, 
