...
avg_df.to_csv("avg_sims_results/" + exposure + str(sim_id) + "_" + save + "_" +  args.task_string + ".csv", index=False)

########################################
# Saving results
########################################
results.to_csv("results/" + exposure + str(sim_id) + "_" + save + "_" +  args.task_string + ".csv", index=False)
